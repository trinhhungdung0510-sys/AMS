...
router = APIRouter(prefix="/rules", tags=["rule-designer"])
...
def update_rule(rule_id: str, payload: BiosecurityRuleUpdate, db: Session = Depends(get_db)) -> BiosecurityRuleResponse:
